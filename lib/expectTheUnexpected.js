...
function expectTheUnexpected(unexpected) {
    ...
    ExpectFacade.prototype.a = function(value) {
        if (value === 'number') {
            return unexpected(
                this.subject,
                expandFlags('[not] to be a number', this.flags)
            );
        }

        return this._unexpectedAssert('[not] to be a', [value]);
    };
    ExpectFacade.prototype.an = ExpectFacade.prototype.a;
    ExpectFacade.prototype.instanceof = ExpectFacade.prototype.a;

    ExpectFacade.prototype.within = function(start, finish) {
        return unexpected(
            this.subject,
            expandFlags(
                this.flags.length
